...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  MX_TIM2_Init();
  /* USER CODE BEGIN 2 */
  HAL_DAC_Start_DMA(&hdac1, DAC_CHANNEL_1, sine_table, sizeof(sine_table)/sizeof(sine_table[0]), DAC_ALIGN_12B_R);
